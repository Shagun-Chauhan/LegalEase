      ...
      <header className={`fixed top-0 ${menuOpen ? 'md:left-64' : 'left-0'} right-0 z-50 bg-white/80 dark:bg-slate-950/80 backdrop-blur-2xl border-b border-slate-200 dark:border-white/5 transition-all duration-300`}>
        <div className="flex items-center justify-between h-20 px-6 md:px-10 max-w-screen-2xl mx-auto">
            ...
            <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate('/dashboard')}>
              ...
              <div className="hidden sm:block">
                <div className="flex items-center gap-1.5">
                  <h1 className="font-display font-bold text-slate-900 dark:text-white text-2xl tracking-tight leading-none group-hover:text-navy-700 dark:group-hover:text-navy-400 transition-colors">LegalEase</h1>
                </div>
                <p className="text-[12px] font-bold uppercase tracking-[0.15em] text-slate-400 dark:text-slate-500 mt-1">Legal Assistant</p>
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:flex flex-1 max-w-lg mx-16">
            ...
            >
              ...
              <input
                ...
                className="w-full pl-12 pr-6 py-3 text-[12px] font-bold uppercase tracking-widest rounded-2xl border border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-slate-900/40 focus:bg-white dark:focus:bg-slate-900 focus:ring-0 focus:border-navy-500/20 transition-all duration-300 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 shadow-sm"
              />

              {/* Search Results Dropdown */}
              {searchFocused && search && (
                <div className="absolute top-full left-0 right-0 mt-3 p-2 bg-white dark:bg-slate-950 rounded-[1.5rem] border border-black dark:border-white/10 shadow-2xl z-[100] animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={toggleTheme}
              className="p-3 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900 transition-all duration-300 text-slate-700 dark:text-slate-400 active:scale-90 group/theme"
            >
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="hidden lg:block text-left">
                  <p className="text-[12px] font-black uppercase tracking-widest text-slate-900 dark:text-white leading-none mb-1">
                    {userName}
                  </p>
                  <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-500 leading-none">Legal Assistant</p>
                </div>
                ...
                <div className="absolute right-0 mt-4 w-64 p-3 bg-white dark:bg-slate-950 rounded-3xl border border-slate-100 dark:border-white/5 shadow-2xl animate-in fade-in slide-in-from-top-4 duration-300 z-50">
                  <div className="space-y-1">
                    <button
                      ...
                      className="w-full flex items-center gap-4 px-4 py-4 rounded-2xl text-[12px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-900 hover:text-navy-600 transition-all group/item"
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-4 px-4 py-4 rounded-2xl text-[12px] font-black uppercase tracking-widest text-red-500 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all group/item"
                    >
